...
public class Places extends MapsJava {
    ...
    /*
    estos url sirven para conectar con la libreria de google maps
    el primero busca el lugar
    el segundo los detalles del sitio
    el tercero la foto del lugar
    */
    ...
    /*
    recibe el resultado del lugar y lo guarda en una matriz tipo array list
    además de sacar el contenido de la información que se ocupa 
    */
    ...
    /*
    crea la url con los datos que ingreso el usuario conviertiendolos en variables para 
    que estos sean más facil de manipular y no se pierdan en el proceso
    */
    ...
    /*
    recibe los detalles del lugar guardados en la array list llamada NodeList
    */
